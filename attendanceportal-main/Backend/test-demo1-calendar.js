...
async function testDemo1Calendar() {
  try {
    ...
    // Simulate the calendar endpoint logic for demo1
    ...
    calendarData.slice(0, 15).forEach((day, index) => {
      if (day.status !== 'empty') {
    ...
    console.log('Employee ID for API:', employeeId);
